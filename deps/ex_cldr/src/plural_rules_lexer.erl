...
-file("src/plural_rules_lexer.erl", 330).
yystate() -> 49.
...
yystate(51, [32|Ics], Line, Tlen, _, _) ->
    yystate(51, Ics, Line, Tlen+1, 18, Tlen);
yystate(51, [9|Ics], Line, Tlen, _, _) ->
    yystate(51, Ics, Line, Tlen+1, 18, Tlen);
yystate(51, [10|Ics], Line, Tlen, _, _) ->
    yystate(51, Ics, Line+1, Tlen+1, 18, Tlen);
...
yystate(49, [8230|Ics], Line, Tlen, Action, Alen) ->
...
yystate(49, [64|Ics], Line, Tlen, Action, Alen) ->
...
yystate(35, Ics, Line, Tlen, _, _) ->
    {13,Tlen,Ics,Line};
yystate(34, [100|Ics], Line, Tlen, Action, Alen) ->
...
yystate(29, [104|Ics], Line, Tlen, Action, Alen) ->
    yystate(25, Ics, Line, Tlen+1, Action, Alen);
yystate(29, Ics, Line, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,29};
yystate(28, [99|Ics], Line, Tlen, Action, Alen) ->
