-file("/Users/airat.badykov/.asdf/installs/erlang/23.2.7/lib/parsetools-2.2/include/leexinc.hrl", 0).
...
-file("/Users/airat.badykov/.asdf/installs/erlang/23.2.7/lib/parsetools-2.2/include/leexinc.hrl", 14).
...
yystate(30, [10|Ics], Line, Tlen, _, _) ->
    yystate(30, Ics, Line+1, Tlen+1, 9, Tlen);
...
yystate(24, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 104 ->
    yystate(4, Ics, Line, Tlen+1, 2, Tlen);
yystate(24, [C|Ics], Line, Tlen, _, _) when C >= 106, C =< 116 ->
    yystate(4, Ics, Line, Tlen+1, 2, Tlen);
...
yystate(14, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(4, Ics, Line, Tlen+1, Action, Alen);
yystate(14, [C|Ics], Line, Tlen, Action, Alen) when C >= 99, C =< 101 ->
    yystate(4, Ics, Line, Tlen+1, Action, Alen);
yystate(14, [C|Ics], Line, Tlen, Action, Alen) when C >= 106, C =< 114 ->
    yystate(4, Ics, Line, Tlen+1, Action, Alen);
yystate(14, [C|Ics], Line, Tlen, Action, Alen) when C >= 118, C =< 122 ->
    yystate(4, Ics, Line, Tlen+1, Action, Alen);
...
yystate(9, Ics, Line, Tlen, _, _) ->
    {2,Tlen,Ics,Line,9};
yystate(8, [122|Ics], Line, Tlen, _, _) ->
    yystate(4, Ics, Line, Tlen+1, 2, Tlen);
yystate(8, [121|Ics], Line, Tlen, _, _) ->
...
yystate(8, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 110 ->
    yystate(4, Ics, Line, Tlen+1, 2, Tlen);
yystate(8, [C|Ics], Line, Tlen, _, _) when C >= 112, C =< 120 ->
    yystate(4, Ics, Line, Tlen+1, 2, Tlen);
...
-file("/Users/airat.badykov/.asdf/installs/erlang/23.2.7/lib/parsetools-2.2/include/leexinc.hrl", 313).
